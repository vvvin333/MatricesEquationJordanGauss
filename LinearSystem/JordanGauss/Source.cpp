...
/// <param name="n"></param>
/// <param name="m"></param>
void fillingMatrixRandom(float** matr, int n, int m)//��������� ������ � � � ���������� �������
{
	for (int i = 0; i < n; i++)
	{
		for (int j = 0; j < m; j++)
...
void fillingMatrixCopy(float** matr, float** matr1, int n, int m) //����� ������(����������)
{
	for (int i = 0; i < n; i++)
		for (int j = 0; j < m; j++)
			matr1[i][j] = matr[i][j];
...
void showMatrix(float** matr, int n, int m)//����� ������� 
{
	for (int i = 0; i < n; i++)
	{
		for (int j = 0; j < m; j++)
...
float** determinantAndChange(float** A, float** E, int n)//������������ � ��������������
{
	bool flag = true;
	for (int i = 0; i < n; i++) //�������� �� ������� �������
	{
...
float** multiplicationMatrix(float** matr1, int n1, int m1, float** matr2, int n2, int m2) //��������� ������
{
	if (m1 != n2)
		printf("������! ��������� ����������!");
	else
...
void sumMatrix(float** matr1, int n1, int m1, float** matr2, int n2, int m2)// �������� ������
{
	if ((n1 != n2) || (m1 != m2))
		printf("������!������� ������ �� ���������!");
	else
...
int main()
{
	...
	for (int i = 0; i < n; i++)
		cB[i] = new float[m];
	float** X = new float* [n];// �������� X
	for (int i = 0; i < n; i++)
		X[i] = new float[m];
	float** T = new float* [n];// �������� T
	for (int i = 0; i < n; i++)
		T[i] = new float[m];
